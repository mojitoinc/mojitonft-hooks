...
export function useContentful(query, variables, options) {
  var _this = this;

  var queryKey = ["Contentful ".concat(EContentfulQueries[query])];
...
export function useContentfulShortLots(mojitoID) {
  var _a = useContentful(EContentfulQueries.shortLots, {
...
export function useContentfulFullLot(mojitoID) {
  var _a = useContentful(EContentfulQueries.fullLot, {
    mojitoId: mojitoID
  }),
      data = _a.data,
      error = _a.error,
...
export function useContentfulAuthors() {
  ...
  var _c = useContentful(EContentfulQueries.authors),
      data = _c.data,
      error = _c.error,
      loading = _c.loading;
...
export function useContentfulCollectors() {
  ...
  var _c = useContentful(EContentfulQueries.collectors),
      data = _c.data,
      error = _c.error,
      loading = _c.loading;
...
export function useContentfulLots(mojitoIds) {
  var _a = useContentful(EContentfulQueries.shortLots, mojitoIds),
      data = _a.data,
      error = _a.error,
      loading = _a.loading;
...
export function useContentfulAuctionsSlugList() {
  ...
  var _d = useContentful(EContentfulQueries.auctionsSlugList),
      data = _d.data,
      error = _d.error,
      loading = _d.loading;
