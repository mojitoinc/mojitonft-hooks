...
import { contentfulGqlClient, mojitoGqlClient, useContentfulAuctionsSlugList, useMarketplaceCollectionsSlugWithItemsId } from '../../hooks';
...
export function useCollection(props) {
  ...
  var auctionSlug = getPath === null || getPath === void 0 ? void 0 : getPath[1];
