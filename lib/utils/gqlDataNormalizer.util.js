...
exports.contentfulNormalizer = exports.mojitoNormalizer = void 0;
...
var extendCollection = function extendCollection(collection) {
  ...
  var contentfulData = (_c = (_b = (_a = gqlRequest_util_1.queryClient.getQueryData(["Contentful ".concat(data_1.EContentfulQueries[data_1.EContentfulQueries.auctionBySlug]), {
  ...
  var auctionStartUnix = (0, moment_1["default"])((_d = collection.startDate) !== null && _d !== void 0 ? _d : null).unix();
  var auctionEndUnix = (0, moment_1["default"])((_e = collection.endDate) !== null && _e !== void 0 ? _e : null).unix();
  var nowUnix = (0, moment_1["default"])().unix();
...
var extendCollectionSingleItem = function extendCollectionSingleItem(item, slug, shortLots) {
  ...
  if (!((_b = _item === null || _item === void 0 ? void 0 : _item.details) === null || _b === void 0 ? void 0 : _b.bids) && !((_c = _item === null || _item === void 0 ? void 0 : _item.details) === null || _c === void 0 ? void 0 : _c.currentBid)) {
    var lot = gqlRequest_util_1.queryClient.getQueryData(["Contentful ".concat(data_1.EContentfulQueries[data_1.EContentfulQueries.fullLot]), {
      mojitoId: item.id
    }]);
...
var extendCollectionItems = function extendCollectionItems(collectionItems, slug) {
  var lots = gqlRequest_util_1.queryClient.getQueryData(["Contentful ".concat(data_1.EContentfulQueries[data_1.EContentfulQueries.shortLots]), {
    slug: slug
  }]);
...
var extendItemDetails = function extendItemDetails(details, slug) {
  ...
  var profile = (_a = gqlRequest_util_1.queryClient.getQueryData(["Mojito ".concat(data_1.EMojitoQueries[data_1.EMojitoQueries.profile]), null])) === null || _a === void 0 ? void 0 : _a.me;
  var item = (_c = (_b = gqlRequest_util_1.queryClient.getQueryData(["Mojito ".concat(data_1.EMojitoQueries[data_1.EMojitoQueries.collectionBySlugCurrentBids]), {
    slug: slug,
  ...
  if (details.startDate && details.endDate) {
    var auctionStartUnix = (0, moment_1["default"])((_d = details.startDate) !== null && _d !== void 0 ? _d : null).unix();
    var auctionEndUnix = (0, moment_1["default"])((_e = details.endDate) !== null && _e !== void 0 ? _e : null).unix();
    var nowUnix = (0, moment_1["default"])().unix();
...
function mojitoNormalizer(response, variables, key) {
  ...
  if (_data === null || _data === void 0 ? void 0 : _data.getMyInvoices) {
    var lots_1 = gqlRequest_util_1.queryClient.getQueryData(["Contentful ".concat(data_1.EContentfulQueries[data_1.EContentfulQueries.shortLots]), {
...
exports.mojitoNormalizer = mojitoNormalizer;

function contentfulNormalizer(response, variables, key) {
  var _a, _b;
...
exports.contentfulNormalizer = contentfulNormalizer;