...
exports.mojitoMutations = exports.EMojitoMutations = void 0;

var graphql_request_1 = require("graphql-request");

var EMojitoMutations;
...
})(EMojitoMutations = exports.EMojitoMutations || (exports.EMojitoMutations = {}));

exports.mojitoMutations = (_a = {}, _a[EMojitoMutations.saveCollectionItemToFavorites] = (0, graphql_request_1.gql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    mutation AddCollectionItemToUserFavorites($collectionItemId: UUID1!) {\n      addCollectionItemToUserFavorites(collectionItemId: $collectionItemId)\n    }\n  "], ["\n    mutation AddCollectionItemToUserFavorites($collectionItemId: UUID1!) {\n      addCollectionItemToUserFavorites(collectionItemId: $collectionItemId)\n    }\n  "]))), _a[EMojitoMutations.removeCollectionItemFromFavorites] = (0, graphql_request_1.gql)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    mutation RemoveCollectionItemFromUserFavorites($collectionItemId: UUID1!) {\n      deleteCollectionItemFromUserFavorites(collectionItemId: $collectionItemId)\n    }\n  "], ["\n    mutation RemoveCollectionItemFromUserFavorites($collectionItemId: UUID1!) {\n      deleteCollectionItemFromUserFavorites(collectionItemId: $collectionItemId)\n    }\n  "]))), _a[EMojitoMutations.createBid] = (0, graphql_request_1.gql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    mutation CreateMarketplaceAuctionBid($marketplaceAuctionLotId: UUID!, $amount: Float!) {\n      createMarketplaceAuctionBid(\n        marketplaceAuctionBid: {\n          marketplaceAuctionLotId: $marketplaceAuctionLotId\n          amount: $amount\n        }\n      ) {\n        id\n        amount\n        marketplaceAuctionLotId\n        userId\n      }\n    }\n  "], ["\n    mutation CreateMarketplaceAuctionBid($marketplaceAuctionLotId: UUID!, $amount: Float!) {\n      createMarketplaceAuctionBid(\n        marketplaceAuctionBid: {\n          marketplaceAuctionLotId: $marketplaceAuctionLotId\n          amount: $amount\n        }\n      ) {\n        id\n        amount\n        marketplaceAuctionLotId\n        userId\n      }\n    }\n  "]))), _a[EMojitoMutations.updateUserOrgSettings] = (0, graphql_request_1.gql)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    mutation ($userOrgId: String!, $username: String, $avatar: String, $settingsJson: String) {\n      updateUserOrgSettings(\n        params: {\n          userOrgId: $userOrgId\n          username: $username\n          avatar: $avatar\n          settingsJson: $settingsJson\n        }\n      ) {\n        id\n      }\n    }\n  "], ["\n    mutation ($userOrgId: String!, $username: String, $avatar: String, $settingsJson: String) {\n      updateUserOrgSettings(\n        params: {\n          userOrgId: $userOrgId\n          username: $username\n          avatar: $avatar\n          settingsJson: $settingsJson\n        }\n      ) {\n        id\n      }\n    }\n  "]))), _a[EMojitoMutations.transferToken] = (0, graphql_request_1.gql)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    mutation (\n      $walletId: UUID1!\n      $tokenId: Int!\n      $contractAddress: String!\n      $transferTo: String!\n      $tokenType: String!\n    ) {\n      transferToken(\n        walletId: $walletId\n        tokenOnChainId: $tokenId\n        contractAddress: $contractAddress\n        transferTo: $transferTo\n        tokenType: $tokenType\n      )\n    }\n  "], ["\n    mutation (\n      $walletId: UUID1!\n      $tokenId: Int!\n      $contractAddress: String!\n      $transferTo: String!\n      $tokenType: String!\n    ) {\n      transferToken(\n        walletId: $walletId\n        tokenOnChainId: $tokenId\n        contractAddress: $contractAddress\n        transferTo: $transferTo\n        tokenType: $tokenType\n      )\n    }\n  "]))), _a);
