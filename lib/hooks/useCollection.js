...
var contentful_query_1 = require("../data/graph_ql/contentful.query");

var general_constants_1 = require("../domain/general.constants");

var utils_1 = require("../utils");

var useContentful_1 = require("./useContentful");
...
function useCollection(props) {
  ...
  var marketplaceCollectionsSlugWithItemsId = (0, useMojito_1.useMarketplaceCollectionsSlugWithItemsId)().marketplaceCollectionsSlugWithItemsId;
  var auctionsSlugList = (0, useContentful_1.useContentfulAuctionsSlugList)().auctionsSlugList;
  var auctionSlug = utils_1.getPath[1];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (token) {
              useMojito_1.mojitoGqlClient.setHeader('authorization', "Bearer ".concat(token.__raw));
            }
            ...
            return [4
            /*yield*/
            , Promise.all([utils_1.queryClient.prefetchQuery(["Contentful ".concat(contentful_query_1.EContentfulQueries[contentful_query_1.EContentfulQueries.auctionBySlug]), {
              slug: auctionSlug
            }], utils_1.gqlRequest.bind(null, {
              query: contentful_query_1.contentfulQueries[contentful_query_1.EContentfulQueries.auctionBySlug],
              variables: {
                slug: auctionSlug
              },
              normalizerFn: utils_1.contentfulNormalizer,
              gqlClient: useContentful_1.contentfulGqlClient
            })), utils_1.queryClient.prefetchQuery(["Contentful ".concat(contentful_query_1.EContentfulQueries[contentful_query_1.EContentfulQueries.shortLots]), {
              slug: auctionSlug
            }], utils_1.gqlRequest.bind(null, {
              query: contentful_query_1.contentfulQueries[contentful_query_1.EContentfulQueries.shortLots],
              variables: {
                slug: auctionSlug,
          ...
          case 2:
            ...
            , (0, utils_1.gqlRequest)({
              ...
              gqlClient: useMojito_1.mojitoGqlClient
            })];
